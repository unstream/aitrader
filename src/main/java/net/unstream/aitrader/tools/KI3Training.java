 ...
 */
public class KI3Training {
	private static Logger log = LoggerFactory.getLogger(KI3Training.class);
	...
	private void train() {
		...
		model.init();
		model.setEpochCount(4);
		model.setInputMiniBatchSize(500);
	...
	public static void main(String[] args) throws IOException {
		KI3Training trainer = new KI3Training();
		trainer.train();
	}
