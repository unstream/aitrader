 ...
 *
 */
public class KI1Strategy implements Strategy {
	...
	public static void loadModel() {
		File modelFile = new File("model1.zip");      //Where to save the network. Note: the file is in .zip format - can be opened externally
		File normalizerFile = new File("normalizer1.norm");
