 ...
 *
 */
public class KI4Strategy implements Strategy {
	...
	public static void loadModel() {
		File modelFile = new File("model4.zip");      //Where to save the network. Note: the file is in .zip format - can be opened externally
		File normalizerFile = new File("normalizer4.norm");
